...
public class App_test_smoke {
    public static void main(String[] args) {
        ...
        System.out.println(tiendaCalzado.valorVenta("ABCD123"));


        System.out.println(tiendaCalzado.calzadosTop());

        System.out.println("El total de impuestos especificos si se vendieran todos los calzados de la tienda" +
                " seria de :$"+tiendaCalzado.totalImpuestosEspecificos());

        System.out.println("El total de descuentos si se vendieran todos los calzados de la tienda" +
                " seria de :$"+tiendaCalzado.totalDescuentos());
    }
}
